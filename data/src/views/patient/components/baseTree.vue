...
<script>
/* eslint-disable */
import fileicon from './images/文件.png'
import filebox from './images/文件夹.png'

import fileiconRed from './images/文件红点.png'
import fileboxRed from './images/文件夹红点.png'

import fileiconGreen from './images/文件绿点.png'
import fileboxGreen from './images/文件夹绿点.png'
